...
def process_incremental_session(session_dir: str, cfg: dict, args: argparse.Namespace) -> list[dict]:
    ...
    from core.recording import count_session_raw_frames, iter_session_raw_frames
...
def main() -> None:
    ...
    if args.recluster_only or args.reprocess_multi:
        from apps.doa_iridium.reprocess_session import reprocess_session
    ...
    if args.compare:
        from apps.doa_iridium.algo_compare import show_algo_comparison
    ...
    if args.replay:
        from apps.doa_iridium.offline_replay import show_replay
    ...
    if args.plot_only:
        from apps.doa_iridium.offline_viz import load_results_for_plot, show_results
    ...
    if args.gui or args.save_fig:
        from apps.doa_iridium.offline_viz import show_results
