...
# shadow the app-local apps/doa/config.py.
...
BORDER = "#3b4263"; DIM    = "#444a64"
BLUE   = "#5ea4e0"; TEAL   = "#4ecdc4"; AMBER  = "#f4a431"
VIOLET = "#a78bfa"; ROSE   = "#f16b6f"; LIME   = "#6dd97d"
TEXT   = "#d8dae8"; MUTED  = "#8891b0"
...
def apply_mpl_style():
    ...
    _plt.rcParams.update({
        ...
        "text.color": TEXT, "grid.color": DIM,
        "grid.alpha": 0.3, "legend.facecolor": BG3,
